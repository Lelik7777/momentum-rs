...
export const getRandomNumber = (min = 1, max = 20) => String(Math.floor(Math.random() * (max - min)) + min);

export const checkNumber = num => num < 10 ? num.padStart(num.length + 1, '0') : num;
